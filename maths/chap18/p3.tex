...
\begin{defn}
	...
	\index{division (polynômes)}
	\index{diviseur (polynôme)}
	\index{multiple (polynôme)}
	\index{association (polynôme)}
\end{defn}
...
\begin{prop-defn}
	...
	\index{reste (division euclidienne, polynômes)}
	\index{quotient (division euclidienne, polynômes)}
\end{prop-defn}
...
\begin{defn}
	...
	\index{irréductibilité (polynôme)}
\end{defn}
...
\begin{defn}
	...
	\index{multiplicité (racine d'un polynôme)}
	\index{racine simple (polynôme)}
	\index{racine double (polynôme)}
\end{defn}
