...
\begin{prop-defn}
	Soit $(E, \le)$ un ensemble ordonné et $A \in \mathcal{P}(E)$ minorée par $m \in E$. On dit que $m$ est une \underline{borne inférieur} \index{borne inférieur} de $A$ si \[
		\begin{cases}
			\forall a \in A,\;m\le a,\\
...
\begin{defn}
	...
	\begin{enumerate}
		\item Soit $M \in E$. On dit qye $M$ est le \underline{plus grand élément} \index{plus grand élément (ensemble)} de $A$ ou que $M$ est le \underline{maximum} \index{maximum (ensemble)} de $A$ si \[
				\begin{cases}
					\forall a \in A,\,a \le M,\\
					M \in A.
				\end{cases}
			\] Dans ce cas, on le note $M = \max(A)$.
		\item Soit $m \in E$. On dit que $m$ est le \underline{plus petit élément} \index{plus petit élément (ensemble)} de $A$ ou que $m$ est le \underline{minimum} \index{minimum (ensemble)} de $A$ si \[
...
\begin{defn}
	...
	On dit que $M$ est un \underline{élément maximal}\index{élément maximal (ensemble)} de $A$ si aucun élément de $A$ n'est strictement supérieur à $M$ : \[
	...
	On dit que $M$ est un \underline{élément minimal}\index{élément minimal (ensemble)} de $A$ si aucun élément de $A$ n'est strictement inférieur à $M$ : \[
		\nexists\, a \in A, \begin{cases}
			M \ge a,\\
			M \neq a.
		\end{cases}
...
\begin{defn}
	...
	\begin{enumerate}
		\item $f$ est \underline{croissante}\index{croissance (application)} si \[
				\forall (x,y) \in E^2, x \le y \implies f(x) \preceq f(y);
			\]
		\item $f$ est \underline{décroissante}\index{décroissance (application)} si \[
...
\begin{defn}
	Soit $(E, \le)$ un ensemble ordonné et $A \in \mathcal{P}(E)$. On dit que $A$ est \underline{bornée} \index{borné (ensemble)} si $A$ est à la fois majorée et minorée.
\end{defn}

\begin{defn}
	Avec les notations précédentes, un \underline{extremum}\index{extremum (ensemble)} de $A$ (sous reserve d'éxistence) est un maximum ou un minimum de $A$.
\end{defn}
